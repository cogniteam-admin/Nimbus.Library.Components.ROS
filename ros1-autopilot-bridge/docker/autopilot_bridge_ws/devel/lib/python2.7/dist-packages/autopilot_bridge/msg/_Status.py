...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3BiBf3BH2BHB3h().pack(_x.mode, _x.armed, _x.ahrs_ok, _x.alt_rel, _x.as_ok, _x.as_read, _x.fence_status, _x.gps_ok, _x.gps_sats, _x.gps_eph, _x.ins_ok, _x.mag_ok, _x.mis_cur, _x.pwr_ok, _x.pwr_batt_rem, _x.pwr_batt_vcc, _x.pwr_batt_cur))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode, _x.armed, _x.ahrs_ok, _x.alt_rel, _x.as_ok, _x.as_read, _x.fence_status, _x.gps_ok, _x.gps_sats, _x.gps_eph, _x.ins_ok, _x.mag_ok, _x.mis_cur, _x.pwr_ok, _x.pwr_batt_rem, _x.pwr_batt_vcc, _x.pwr_batt_cur,) = _get_struct_3BiBf3BH2BHB3h().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_3BiBf3BH2BHB3h = None
def _get_struct_3BiBf3BH2BHB3h():
    global _struct_3BiBf3BH2BHB3h
    if _struct_3BiBf3BH2BHB3h is None:
        _struct_3BiBf3BH2BHB3h = struct.Struct("<3BiBf3BH2BHB3h")
    return _struct_3BiBf3BH2BHB3h
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
