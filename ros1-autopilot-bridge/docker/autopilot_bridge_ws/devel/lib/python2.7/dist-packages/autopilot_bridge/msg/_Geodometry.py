...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4d2B4d().pack(_x.pose.pose.position.lat, _x.pose.pose.position.lon, _x.pose.pose.position.alt, _x.pose.pose.position.rel_alt, _x.pose.pose.position.using_alt, _x.pose.pose.position.using_rel_alt, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pose.pose.position.lat, _x.pose.pose.position.lon, _x.pose.pose.position.alt, _x.pose.pose.position.rel_alt, _x.pose.pose.position.using_alt, _x.pose.pose.position.using_rel_alt, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w,) = _get_struct_4d2B4d().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_4d2B4d = None
def _get_struct_4d2B4d():
    global _struct_4d2B4d
    if _struct_4d2B4d is None:
        _struct_4d2B4d = struct.Struct("<4d2B4d")
    return _struct_4d2B4d
_struct_6d = None
def _get_struct_6d():
    global _struct_6d
