...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4d2B4d().pack(_x.pose.position.lat, _x.pose.position.lon, _x.pose.position.alt, _x.pose.position.rel_alt, _x.pose.position.using_alt, _x.pose.position.using_rel_alt, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pose.position.lat, _x.pose.position.lon, _x.pose.position.alt, _x.pose.position.rel_alt, _x.pose.position.using_alt, _x.pose.position.using_rel_alt, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w,) = _get_struct_4d2B4d().unpack(str[start:end])
