...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4d2B().pack(_x.lat, _x.lon, _x.alt, _x.rel_alt, _x.using_alt, _x.using_rel_alt))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.lat, _x.lon, _x.alt, _x.rel_alt, _x.using_alt, _x.using_rel_alt,) = _get_struct_4d2B().unpack(str[start:end])
