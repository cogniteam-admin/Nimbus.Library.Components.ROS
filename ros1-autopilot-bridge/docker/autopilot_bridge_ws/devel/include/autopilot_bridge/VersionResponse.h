...
struct VersionResponse_
{
  ...
  _board_type board;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _flight_custom_type;
  _flight_custom_type flight_custom;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _middleware_custom_type;
  _middleware_custom_type middleware_custom;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _os_custom_type;
...
bool operator==(const ::autopilot_bridge::VersionResponse_<ContainerAllocator1> & lhs, const ::autopilot_bridge::VersionResponse_<ContainerAllocator2> & rhs)
{
  return lhs.ok == rhs.ok &&
    lhs.cap_mission_float == rhs.cap_mission_float &&
    lhs.cap_param_float == rhs.cap_param_float &&
    lhs.cap_mission_int == rhs.cap_mission_int &&
    lhs.cap_command_int == rhs.cap_command_int &&
    lhs.cap_param_union == rhs.cap_param_union &&
    lhs.cap_ftp == rhs.cap_ftp &&
    lhs.cap_set_attitude == rhs.cap_set_attitude &&
    lhs.cap_set_position_local == rhs.cap_set_position_local &&
    lhs.cap_set_position_global == rhs.cap_set_position_global &&
    lhs.cap_terrain == rhs.cap_terrain &&
    lhs.cap_set_actuator == rhs.cap_set_actuator &&
    lhs.flight_sw == rhs.flight_sw &&
    lhs.middleware == rhs.middleware &&
    lhs.os_sw == rhs.os_sw &&
    lhs.board == rhs.board &&
    lhs.flight_custom == rhs.flight_custom &&
    lhs.middleware_custom == rhs.middleware_custom &&
    lhs.os_custom == rhs.os_custom &&
...
struct Printer< ::autopilot_bridge::VersionResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autopilot_bridge::VersionResponse_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.flight_custom);
    s << indent << "middleware_custom: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.middleware_custom);
    s << indent << "os_custom: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.os_custom);
    s << indent << "vendor_id: ";
